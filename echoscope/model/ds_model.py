...
class FieldModel(object):
  ...
  def __init__(self, name: str, ftype: str, length: int = 0, scale: int = 0, default: str = '', nullFlag: bool = False, comment: str = '', charset: str = '', collation_name: str = '', indexFlag: int = 0, indexName: str = '', autoInc: bool = False):
    """初始化
